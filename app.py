...
server = os.getenv('DB_SERVER', 'aichafrih.database.windows.net')  # Nom du serveur Azure
database = os.getenv('DB_NAME', 'societe')  # Nom de la base de données
username = os.getenv('DB_USER', 'aicha')  # Nom d'utilisateur
password = os.getenv('DB_PASSWORD', '142536475869aA')  # Mot de passe
